...
// Parameter per channel
#define THP_ParamBlockOffset 2606
#define THP_ParamBlockSize 52
#define THP_Sensortype_                0      // 8 Bits, Bit 7-0
#define THP_SensorTemperatureSendChangeAmount_  1      // float
#define THP_SensorTemperatureSendCycle_  3      // 8 Bits, Bit 7-0
#define THP_SensorTemperatureAlign_    4      // float
#define THP_SensorTemperatureWarnL_    6      // float
#define THP_SensorTemperatureWarnH_    8      // float
#define THP_SensorTemperatureMinMax_  10      // 1 Bit, Bit 7
#define     THP_SensorTemperatureMinMax_Mask 0x80
#define     THP_SensorTemperatureMinMax_Shift 7
#define THP_SensorHumiditySendChangeAmount_ 11      // float
#define THP_SensorHumiditySendCycle_  13      // 8 Bits, Bit 7-0
#define THP_SensorHumidityAlign_      14      // float
#define THP_SensorHumidityWarnL_      16      // float
#define THP_SensorHumidityWarnH_      18      // float
#define THP_SensorHumidityMinMax_     20      // 1 Bit, Bit 7
#define     THP_SensorHumidityMinMax_Mask 0x80
#define     THP_SensorHumidityMinMax_Shift 7
#define THP_SensorHumiditySend_       21      // 8 Bits, Bit 7-0
#define THP_SensorAbsHumiditySendChangeAmount_ 22      // float
#define THP_SensorAbsHumiditySendCycle_ 24      // 8 Bits, Bit 7-0
#define THP_SensorAbsHumidityAlign_   25      // float
#define THP_SensorAbsHumidityWarnL_   27      // float
#define THP_SensorAbsHumidityWarnH_   29      // float
#define THP_SensorAbsHumidityMinMax_  31      // 1 Bit, Bit 7
#define     THP_SensorAbsHumidityMinMax_Mask 0x80
#define     THP_SensorAbsHumidityMinMax_Shift 7
#define THP_SensorDewPointSendChangeAmount_ 32      // float
#define THP_SensorDewPointSendCycle_  34      // 8 Bits, Bit 7-0
#define THP_SensorDewPointAlign_      35      // float
#define THP_SensorDewPointWarnL_      37      // float
#define THP_SensorDewPointWarnH_      39      // float
#define THP_SensorDewPointMinMax_     41      // 1 Bit, Bit 7
#define     THP_SensorDewPointMinMax_Mask 0x80
#define     THP_SensorDewPointMinMax_Shift 7
#define THP_SensorPressureSendChangeAmount_ 42      // float
#define THP_SensorPressureSendCycle_  44      // 8 Bits, Bit 7-0
#define THP_SensorPressureAlign_      46      // float
#define THP_SensorPressureWarnL_      47      // float
#define THP_SensorPressureWarnH_      49      // float
#define THP_SensorPressureMinMax_     51      // 1 Bit, Bit 7
#define     THP_SensorPressureMinMax_Mask 0x80
#define     THP_SensorPressureMinMax_Shift 7

// Communication objects per channel (multiple occurrence)
#define THP_KoOffset 20
#define THP_KoBlockSize 30
